...
class CrossReferencesGeneratorPSQL:
    ...
    def generate(self):
        ...
        sql_dir = os.path.join(self.format_dir, 'psql', 'extras')
...
\n""")
            ...
            for ref in data['cross_references']:
                ...
                for to_verse in ref['to_verse']:
                    sqlfile.write(f"""INSERT INTO cross_references (from_book, from_chapter, from_verse, to_book, to_chapter, to_verse_start, to_verse_end, votes) VALUES ('{from_verse['book']}', {from_verse['chapter']}, {from_verse['verse']}, '{to_verse['book']}', {to_verse['chapter']}, {to_verse['verse_start']}, {to_verse['verse_end']}, {ref['votes']});
""")
